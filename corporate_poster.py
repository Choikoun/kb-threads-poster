...
TOPICS = [
    ...
    "배당소득 분리과세로 바뀌었다 — 고배당 받는 사장님, 합산과세 공포에서 벗어나는 구조 (2026 개정)",
    "가업상속공제 요건이 완화됐다 — 승계 타이밍과 지분 구조를 다시 계산해야 하는 이유 (2026 개정)",
    "비상장주식 평가방식이 바뀌었다 — 우리 법인 주식 가치가 달라지면 승계·증여 셈법도 달라진다 (2026 개정)",
    "법인세율 전 구간 1%p 올랐다 — 이익잉여금 쌓아두던 구조, 다시 봐야 하는 시점 (2026 개정)",
]
