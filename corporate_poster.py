...
TOPICS = [
    ...
    "법인계약 개인 계약자 변경, 이제 원칙적으로 막혔다 — 절세효과 강조하던 그 구조, 지금 점검해야 하는 이유",
    "매출 커지면 무조건 법인전환? — 이중과세·정보노출까지 따지면 개인사업자가 나을 때도 있다",
    ...
    "동업, 친구라서 시작했는데 친구라서 더 못 끝낸다 — 지분 50:50, 사이좋을 때는 공평한데 갈라설 때는 회사가 멈춘다",
    "동업자가 회사 기회를 몰래 개인적으로 챙겼다면 — 신의성실 의무 위반, 법은 알고 있다",
    "MSO 설립, 절세 목적으로만 보면 놓치는 것",
    "회사 매각 준비, 매수자가 보는 건 매출이 아니라 구조다",
    "명의신탁주식 실제소유자 확인, 소송까지 가는 이유는 따로 있다",
    "가업승계 방법이 다섯 가지나 되는데, 2026년 세법개정안 이후로 유리한 조합이 바뀐다",
    "가지급금 갚는 것도 계획이 있어야 한다 — 무작정 갚으면 오히려 세금이 붙는다",
    "배우자 지분으로 이익소각 하면 세금이 달라진다 — 근데 신고를 제대로 안 하면 의미가 없다",
    "임원 퇴직금, 정관에 안 써있으면 세무서가 인정 안 해준다",
    "중대재해처벌법 벌금이 20억까지 뛰었다 — 사장님 개인이 그 돈을 감당할 수 있나",
    "업무추진비, 증빙 없이 쓰면 나중에 다 대표 소득으로 잡힌다",
    "작년에 낸 세금, 다시 돌려받을 수 있는 경우가 있다 — 대부분 모르고 그냥 넘어간다",
    "법정 의무교육이 다섯 가지나 되는 거 알고 있었나 — 안 하면 과태료다",
]

# 웹리서치(2026-06-21): 동업자는 사업 파트너이면서 친구·지인인 경우가 많아, 압박하면 관계가 끊기고
# 물러서면 손해가 쌓이는 딜레마가 갈등을 오래 끌고 감 — 신의성실 의무 위반(회사 기회 개인적 이용,
# 정보 은닉, 자금 부당 사용)도 반복되는 분쟁 유형. inheritance_poster.py의 EMOTIONAL_TOPICS와 같은
# 개념 — 금/토/일 가중치는 corporate_poster.py main()에 아직 미적용, 필요시 추가
EMOTIONAL_TOPICS = {
    "동업, 친구라서 시작했는데 친구라서 더 못 끝낸다 — 지분 50:50, 사이좋을 때는 공평한데 갈라설 때는 회사가 멈춘다",
    "동업자가 회사 기회를 몰래 개인적으로 챙겼다면 — 신의성실 의무 위반, 법은 알고 있다",
}
