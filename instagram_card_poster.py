...
[caption 작성 — 인스타 알고리즘 고려]
- 1줄: 스크롤 멈추게 하는 강한 훅 (숫자·반전 위주, 인스타는 캡션 앞 1~2줄만 보이고 "더보기"로 잘림)
↵빈줄
- 2~3줄: 핵심 요약
↵빈줄
- 마지막 줄: 저장 또는 공유를 자연스럽게 유도 (예: "캡쳐해두고 나중에 다시 봐", "내 주변에 해당되는 사람 있으면 공유해줘" 류, 매번 다르게 변형. 10번 중 1~2번 정도는 "더 깊은 얘기는 쓰레드에도 있어" 류로 변형해도 좋음. DM·상담 유도는 절대 금지)
- 전체 200자 이내
...
{{
  ...
  "caption": "인스타 본문 (위 caption 작성 규칙 따름, 200자 이내)",
  "hashtags": ["증여", "상속", "법인절세", "절세", "자산설계", "사업주", "자산가", "세금", "재테크", "법인세"]
}}"""
