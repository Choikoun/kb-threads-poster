...
TOPICS = [
    ...
    "장남이라서 부모님 다 떠안았는데, 상속은 형제들이랑 똑같이 나눠야 한다고? — 기여와 분배는 따로 노는 법이다",
    "부모님 병원비 혼자 냈는데, 나중에 형제들은 상속권만 주장한다 — 간병한 기여, 법은 알아서 안 챙겨준다",
    "결혼할 때 받은 돈 있으니 상속에서 빼라는 형제 — 생전 증여와 사후 상속은 셈법부터 다르다",
    "부모 부양해야 한다는 자식, 2007년 53%에서 2022년 21%로 줄었다 — 효도는 마음이 아니라 설계의 문제가 됐다",
    "유류분 소송, 10년 만에 3배로 늘었다 (2012년 590건 → 2022년 1,872건) — 가족이라서 더 무섭게 싸운다",
    "상속재산분할 소송, 한 해 2천 건이 넘는다 — 너희 가족만은 다를 거라는 착각",
    "ISA 계좌 만들면 세금 다 아낀다며? — 국내주식만 담으면 그 혜택 그대로 못 받는 사람 많다",
    "상속세 연부연납 걸어놨는데 은행 대출이 안 나온다? — 부동산은 있는데 세금 낼 현금이 없는 이유",
    "세무사 상담 30분에 5만원, 비싼 걸까 — 상담료보다 무서운 건 뭘 물어봐야 하는지 모르는 것",
    "자녀공제가 5천만원에서 5억으로 뛰었다 — 이제 무리한 사전증여가 오히려 손해일 수 있는 이유 (2026 개정)",
    "형제자매 유류분이 폐지됐다 — 특정 자녀에게 다 물려줘도 이제 못 뒤집는다 (2026 민법 개정)",
    "부모 간병한 기여, 이제 유류분·특별수익 계산에서 빼준다 — 헌신이 드디어 법적 보상으로 (2026 개정)",
    "유류분 반환, 이제 재산 자체가 아니라 현금(가액)으로 — 물려준 부동산·주식 그대로 뺏기던 시대는 끝났다 (2026 개정)",
]

# 전체 히스토리 분석(2026-06-21) 결과 금/토/일 평균 조회수가 평일보다 뚜렸하게 높고,
# 역대 최고 히트(이혼 재산분할, 요양원)도 둘 다 일요일 — 감정적 생활밀착형 주제를 주말에 가중
# 핵심 프레임(웹리서치, 2026-06-21): "문화적으로 당연시되는 가족 헌신(효도·간병)과 실제 법적·금전적
# 보상의 불일치"가 이런 콘텐츠가 터지는 심리적 이유 — 이 프레임에 맞는 주제를 EMOTIONAL_TOPICS로 분류
# 통계 출처(2026-06-21 웹리서치): 부모부양의식 53%→21%·유류분소송 590→1,872건(매거진한경/한국보건사회연구원
# 등 보도 기준, 추후 본문에 쓸 때는 최신 통계로 재확인 권장 — 연도가 지나면 갱신 필요)
EMOTIONAL_TOPICS = {
    "자녀에게 증여한 재산, 이혼하면 재산분할 대상이 될 수도 있다 — 증여만으로는 안 끝난다",
    "요양원도 자식 신세도 싫다면 — 노후 준비는 가족이 아니라 구조로 해야 한다",
    "장남이라서 부모님 다 떠안았는데, 상속은 형제들이랑 똑같이 나눠야 한다고? — 기여와 분배는 따로 노는 법이다",
...
이 계정의 역대 최고 히트들은 "문화적으로 당연시되는 가족 헌신(효도·간병·장남 책임)과 실제 법적·금전적 보상의 불일치"를 건드린 주제였다 — 오늘 주제를 풀 때 이 불일치 지점이 자연스럽게 있다면 적극적으로 살려라(억지로 끌어오지는 말 것).
