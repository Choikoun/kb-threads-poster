...
34세에 가입하면 65세부터 평생 매달 73만원.

37세에 가입하면 똑같은 조건인데 매달 63만원.

딱 3년 차인데 매달 10만원, 100세까지 다 받으면 4천만원 넘게 차이나.

이유는 간단해. 가입부터 수령 시작까지 거치기간이 길수록, 그 기간 붙는 이자가 더 쌓이는 구조라서 그래.

물론 이건 공시이율 기준 예시라 실제론 달라질 수 있고, 중간에 해지하면 원금보다 적게 나올 수도 있어.

근데 확실한 건 하나야. 고민하는 동안 흘러가는 시간이, 그대로 손해로 쌓인다는 거.''',
        'card_data': {
            'tag': '# 노후연금',
            'hook_big': '연금보험, 3년 차이가\n매달 10만원을 가른다',
            'hook_sub': '같은 조건, 가입 나이만 다른 두 사례',
            'points': [
                {'title': '34세 가입', 'body': '월 80만원 · 7년납\n65세부터 매달\n73만원'},
                {'title': '37세 가입', 'body': '같은 조건인데\n65세부터 매달\n63만원'},
                {'title': '100세까지 누적', 'body': '3억 1,609만원 vs\n2억 7,469만원\n(약 4,100만원 차이)'},
                {'title': '왜 차이 나나', 'body': '거치기간이 길수록\n붙는 이자가 더\n오래 쌓이는 구조'},
            ],
            'closing': '가입 시점이 빠를수록\n유리해지는 구조입니다.',
            'cta': '내 나이엔 어떻게 계산될지\n궁금하신가요?'
        },
        'caption': '''연금보험, 가입 시점 3년 차이가 실제로 얼마나 벌어질까요?
...
왜 이런 차이가 날까요? 거치 기간이 길수록 최저연금기준금액에 붙는 이자가 더 오래 쌓이는 구조이기 때문입니다.

물론 실제 수령액은 공시이율 변동에 따라 달라질 수 있고, 중도 해지 시에는 납입한 금액보다 적게 받으실 수 있습니다. (2026년 8월 공시이율 2.55% 기준 예시금액)
